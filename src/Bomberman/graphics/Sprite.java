...
public class Sprite {
	...
	/**
	 * Ảnh động tạo bởi 3 Sprite luân phiên nhau.
	 * @param normal Sprite 1.
	 * @param x1 Sprite 2.
	 * @param x2 Sprite 3.
	 * @param animate thời gian hiện tại, đơn vị mili giây.
	 * @param time chu kì lặp lại, đơn vị mili giây.
	 * @return
	 */
	...
	/**
	 * Ảnh động tạo bởi 2 Sprite luân phiên nhau.
	 * @param x1 Sprite 1.
	 * @param x2 Sprite 2.
	 * @param animate thời gian hiện tại, đơn vị mili giây.
	 * @param time chu kì lặp lại, đơn vị mili giây.
