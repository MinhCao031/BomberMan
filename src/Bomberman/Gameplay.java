...
import Bomberman.entities.Enemy.EnemySpawner;
                ...
                for (int j = 0; j < col; ++j) {
                    switch (rowOfChar.charAt(j)) {
                        ...
                        case 'o': {
                            Grass grass = new Grass(j, i, Sprite.grass.getFxImage());
                            immunities.add(grass);
                            Brick hasBombPass = new Brick(j, i, Sprite.brick.getFxImage(), new BombPushItem(j, i));
                        ...
                        case '1': {
                            Grass grass = new Grass(j, i, Sprite.grass.getFxImage());
                            immunities.add(grass);
                            Enemy balloom = new Balloom(j, i, Sprite.custom_left2[0].getFxImage());
                            //---------------------------------------------------
                        ...
                        case '2': {
                            Grass grass = new Grass(j, i, Sprite.grass.getFxImage());
                            immunities.add(grass);
                            Enemy oneal = new Oneal(j, i, Sprite.custom_left3[0].getFxImage());
                        ...
                        case '3': {
                            Grass grass = new Grass(j, i, Sprite.grass.getFxImage());
                            immunities.add(grass);
                            Enemy spawner = new EnemySpawner(j, i, Sprite.custom_left1[0].getFxImage());
                            animations.add(spawner);
                            break;
                        }
                        case 'p': {
//                            Grass grass = new Grass(j, i, Sprite.grass.getFxImage());
